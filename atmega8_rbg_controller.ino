/* todo
   управление с кнопки (
   нажимаем кнопку, включаем питание
   пока держим яркость изменяется от 0 до 255 и обратно
   если отпустили следующий клик запускает регулировку скорость
   пока держим скорость изменяется
   выход из регулировки

   нормальный режим
   клик включает следующий режим
   удержание выключает
   если выключено и кликнуть то включается
*/
